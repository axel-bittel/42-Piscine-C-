...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/07/12 15:10:56 by abittel           #+#    #+#             */
/*   Updated: 2022/07/12 15:37:32 by abittel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    mstack2.push_back(3);mstack2.push_back(5);mstack2.push_back(737);
    mstack2.erase(mstack2.begin(), mstack2.end());
    for (int i = 0; i <= 20; i++)
        mstack2.push_back(i);
    //[...]
    mstack2.push_back(0);
